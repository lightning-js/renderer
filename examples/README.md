...
- `platform` (string, default: "web")
  ...
  - Options: `web` (modern createImageBitmap with full options), `chrome50` (limited createImageBitmap, no options/cropping), `legacy` (HTMLImageElement, no createImageBitmap)
