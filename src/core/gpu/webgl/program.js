    ...
    if(success){
        return {
            enableAttributes(){
                ...
                gl.vertexAttribPointer(colorAttributeLocation, 4, gl.FLOAT, false, stride, 2 * Float32Array.BYTES_PER_ELEMENT);

                gl.enableVertexAttribArray(textureAttributeLocation);
                gl.vertexAttribPointer(textureAttributeLocation, 2, gl.FLOAT, false, stride, 6 * Float32Array.BYTES_PER_ELEMENT);
